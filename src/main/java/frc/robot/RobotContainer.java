...
public class RobotContainer {
        ...
        public RobotContainer() {
                switch (Constants.currentMode) {
                        case REAL:
                                ...
                                elevator = new Elevator(new ElevatorReal(transfer.getIO()::isCoralIn, brakeSwitch));
                                arm = new CoralArm(new CoralArmIOReal(brakeSwitch));
                                riffCommands = new RiffCommands(elevator, arm, transfer);
                                break;
        ...
        private void configureButtonBindings() {
                driverController.a().whileTrue(riffCommands.throwToNet());
                driverController.x().onTrue(TransferCommands.coralintake(transfer, 3));
                driverController.b()
                                .onTrue(riffCommands.closeAll()
                                                .alongWith(TransferCommands.coralintake(transfer, 0)));
