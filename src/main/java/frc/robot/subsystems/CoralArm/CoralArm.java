...
public class CoralArm extends SubsystemBase {
    ...
    public CoralArm(CoralArmIO io) {
        this.io = io;
        // setDefaultCommand(new ConditionalCommand(run(() -> io.setVoltage(-0.5)),
        // run(() -> io.stayInCurrentGoal()),
        // io::getLowSwitch).withName("DefaultCommand"));

        setDefaultCommand(run(() -> io.stayInCurrentGoal()).withName("DefaultCommand"));
