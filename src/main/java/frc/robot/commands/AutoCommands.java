        ...
        return Commands.sequence(
                Commands.parallel(
                        ...
                        driveToPoseInCorrectAlliance(drive,
                                new Pose2d(new Translation2d(6.45, 6.3), new Rotation2d(-140))))
                        .until(() -> SwerveCommands.LocateToReefCommand.isAnyReefCloseEnough(drive.getPose(),
                                false)),
                placeCoralInReef(4, false),
                Commands.parallel(
                        driveToPoseInCorrectAlliance(drive,
                                new Pose2d(new Translation2d(4.1, 5.1), new Rotation2d(Units.degreesToRadians(-35))))),
                intakeFromLeftFeeder(),
                Commands.parallel(
                        driveToPoseInCorrectAlliance(drive,
                                new Pose2d(new Translation2d(2, 6), new Rotation2d(-44))))
                        .until(() -> SwerveCommands.LocateToReefCommand.isAnyReefCloseEnough(drive.getPose(),
                                false)),
